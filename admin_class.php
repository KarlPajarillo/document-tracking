...
Class Action {
	...
	function deny_resend_parcel(){
		extract($_POST);
		$update = $this->db->query("UPDATE parcels set dlt= $dlt where id = $id");
		$save = $this->db->query("INSERT INTO parcel_tracks set status= '4' , parcel_id = $id");
		if($update && $save)
			return 1;  
	}
